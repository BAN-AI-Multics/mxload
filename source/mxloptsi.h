char *ascii_cv_values[] =
     {"ascii", "8bit", "8bit+9bit", "9bit", "discard", NULL};
char *nonascii_cv_values[] =
     {"nonascii", "9bit", "8bit", "8bit+9bit", "discard", NULL};
char *object_cv_values[] =
     {"object", "discard", "8bit", "8bit+9bit", "9bit", NULL};
char *ascii_archive_cv_values[] =
     {"ascii_archive", "unpack", "8bit", "9bit", "8bit+9bit", "discard", NULL};
char *nonascii_archive_cv_values[] =
     {"nonascii_archive", "9bit", "unpack", "8bit", "8bit+9bit",
     "discard", NULL};
char *mbx_cv_values[] =
     {"mbx", "9bit", "unpack", "repack", "8bit", "8bit+9bit", "discard", NULL};
char *ms_cv_values[] =
     {"ms", "discard", "8bit", "8bit+9bit", "9bit", "unpack", NULL};
...
char *force_convert_file_cv_types[] =
     {"force_convert", "8bit", "8bit+9bit", "9bit", "discard", NULL};
...
char *name_type_cv_values[] =
     {"name_type", "MSDOS", "SysV", "BSD", "CMS", NULL};
#else
#ifdef BSD
char *name_type_cv_values[] =
     {"name_type", "BSD", "SysV", "CMS", "MSDOS", NULL};
#else
char *name_type_cv_values[] =
     {"name_type", "SysV", "BSD", "CMS", "MSDOS", NULL};
#endif
#endif
